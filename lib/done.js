...
/**
 * done.mkdir(dir, mode, iterator(err, path, cb){}, finished(err){})
 * 
 ...
 */
exports.mkdir = function(dir, mode, iterator, finished) {
  ...
  fs.mkdir(dir, mode, function(err) {
    ...
    var done = function(err) {
      ...
      exports.mkdir(dir, mode, iterator, finished);
    }
    
    if (err) {
      if (err.code == "ENOENT") // parent dir doesn't exist, create it
        exports.mkdir(parent, mode, iterator, done); 
